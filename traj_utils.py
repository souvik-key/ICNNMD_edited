...
def read_traj(file_nc,file_top, stride=1): # added
    
    #traj = md.load(file_nc,top=file_top)[:100]
    #traj = md.load(file_nc,top=file_top)[:14000] #added
    traj = md.load(file_nc,stride=stride, top=file_top) #added
...
def load_traj(file0_1, file1_1, file0_2, file1_2, stride): # added
    # =============================================================================
    # traj0
    #file0_traj = read_traj(file0_1, file0_2)
    file0_traj = read_traj(file0_1, file0_2, stride) #added
    # traj1
    #file1_traj = read_traj(file1_1, file1_2)
    file1_traj = read_traj(file1_1, file1_2, stride) #added
...
def traj_pre(file0_1, file1_1, file0_2, file1_2, stride):
    import numpy as np

    traj0_hex, traj1_hex, pixel0, pixel1 = load_traj(file0_1, file1_1, file0_2, file1_2, stride)
